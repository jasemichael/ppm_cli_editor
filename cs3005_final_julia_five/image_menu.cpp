...
void showMenu(std::ostream& os){
    ...
    << "julia-five) Choose to make a Julia set with the fifth power function." << "set-color-gradient) Smoothly set the RGB values for a range of slots in the color table." <<"\nquit) Quit" << "\n\n";
}
